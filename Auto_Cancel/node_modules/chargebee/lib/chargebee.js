...
var Q = require("chargebee/lib/node_modules/q");
var os = require("chargebee/lib/node_modules/os");
ChargeBee._env = {
    protocol: 'https',
...
ChargeBee._endpoints = require('chargebee/lib/resources/api_endpoints.js');
...
ChargeBee._core = (function() {
    var coreRef = {};
    var http = require('chargebee/lib/node_modules/http');
    var https = require('chargebee/lib/node_modules/https');
